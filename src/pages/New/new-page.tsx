...
const NewPage: React.FunctionComponent<IComponentProps> = (
  ...
  React.useEffect(
    () => {
      dispatch(Items.actions.getAllStoriesByType('new', page));
    },
    [page]
  );
...
const enhancedNewPage = connect(mapStateToProps)(NewPage);

export { enhancedNewPage as NewPage };
