...
const NewsPage: React.FunctionComponent<IComponentProps> = (
  ...
  React.useEffect(
    () => {
      dispatch(Items.actions.getAllStoriesByType('news', page));
    },
    [page],
  );
...
const enhancedNewsPage = connect(mapStateToProps)(NewsPage);

export { enhancedNewsPage as NewsPage };
