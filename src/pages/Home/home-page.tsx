...
const HomePage: React.FunctionComponent<IComponentProps> = (
  ...
  React.useEffect(
    () => {
      dispatch(Items.actions.getAllStoriesByType('top', page));
    },
    [page]
  );
...
const enhancedHomePage = connect(mapStateToProps)(HomePage);

export { enhancedHomePage as HomePage };
